...
public class ProductDaoTest extends BaseTest {
	...
	public void testAInsertProduct() throws Exception {
		...
		product2.setProductName("测试4");
		product2.setProductDesc("测试Desc4");
		product2.setImgAddr("test4");
		...
		product3.setProductName("test5");
		product3.setProductDesc("测试Desc5");
		product3.setImgAddr("test5");
